...
.method public k()V
    ...
    :goto_0
    iget-object v2, p0, Li/f;->y:Li/b;

    invoke-direct {p0, v2, v1, v1}, Li/f;->s(Li/b;FF)V

    iget-object v2, p0, Li/f;->z:Li/b;

    invoke-direct {p0, v2, v1, v1}, Li/f;->s(Li/b;FF)V

    iget-object v2, p0, Li/f;->A:Li/b;
    ...
    invoke-direct {p0, v2, v3, v3}, Li/f;->s(Li/b;FF)V

    iget-object v2, p0, Li/f;->C:Li/b;

    invoke-direct {p0, v2, v1, v1}, Li/f;->s(Li/b;FF)V

    iget-object v2, p0, Li/f;->D:Li/b;

    invoke-direct {p0, v2, v1, v1}, Li/f;->s(Li/b;FF)V

    iget-object v1, p0, Li/f;->E:Li/b;

    invoke-direct {p0, v1, v3, v3}, Li/f;->s(Li/b;FF)V
    ...
    :cond_1
    iget-object v0, p0, Li/f;->y:Li/b;

    invoke-direct {p0, v0, v1}, Li/f;->t(Li/b;F)V

    iget-object v0, p0, Li/f;->z:Li/b;

    invoke-direct {p0, v0, v1}, Li/f;->t(Li/b;F)V

    iget-object v0, p0, Li/f;->A:Li/b;
    ...
    iget-object v0, p0, Li/f;->C:Li/b;

    invoke-direct {p0, v0, v2}, Li/f;->t(Li/b;F)V

    iget-object v0, p0, Li/f;->D:Li/b;

    invoke-direct {p0, v0, v2}, Li/f;->t(Li/b;F)V

    iget-object v0, p0, Li/f;->E:Li/b;
